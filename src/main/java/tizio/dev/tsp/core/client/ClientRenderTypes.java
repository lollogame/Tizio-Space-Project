...
public final class ClientRenderTypes extends RenderType {
    ...
    private static final RenderType PLANET_RING_ROCKS_OPAQUE = create(
            "planet_ring_rocks_opaque",
            DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS,
            256,
            false,
    ...
    private static final RenderType PLANET_RING_ROCKS_TRANSPARENT = create(
            "planet_ring_rocks_transparent",
            DefaultVertexFormat.POSITION_TEX,
            VertexFormat.Mode.QUADS,
            256,
            false,
    ...
    public static RenderType planetRingRocksOpaque()      { return PLANET_RING_ROCKS_OPAQUE; }
    public static RenderType planetRingRocksTransparent() { return PLANET_RING_ROCKS_TRANSPARENT; }
