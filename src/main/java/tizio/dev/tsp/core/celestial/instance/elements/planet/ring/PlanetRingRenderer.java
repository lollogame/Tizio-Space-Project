...
public final class PlanetRingRenderer {
    ...
    private static void renderInstance(ShaderInstance shader, PlanetInstance.RingInstance instance, Camera camera, Frustum frustum, PoseStack poseStack, MultiBufferSource.BufferSource bufferSource) {
