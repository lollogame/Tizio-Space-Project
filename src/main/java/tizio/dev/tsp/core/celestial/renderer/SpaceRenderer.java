...
import tizio.dev.tsp.core.celestial.instance.elements.OrbitPathRenderer;
...
public final class SpaceRenderer {
    ...
    public static void onRenderLevelStage(RenderLevelStageEvent event) {
        ...
        if (!CelestialJsonLoader.isSpaceDimension(minecraft.level.dimension().location())) return;
        ...
        List<VolumeRenderUtil.RenderTask> tasks = VolumeRenderUtil.mergeSorted(
                ...
                OrbitPathRenderer.buildTasks(camera, poseStack, bufferSource)
        );
